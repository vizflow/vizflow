document.framerate_test = function framerate_page(Ncircle) {
  ...
  fps.update = function () {
    ...
    if (dIter >= iterDur) {
      ...
      fpsTextConfig.text = Math.round(prec * fpsVal) / prec ;
  ...
  // viz.post = undefined ;
  // viz.fullCanvas.place( vizConfig.parentElement ) ;
  // viz.fullCanvas.style.width = '100%';
  // viz.fullCanvas.style.height = '100%';

  // viz.screenCanvas = viz.fullCanvas ;
